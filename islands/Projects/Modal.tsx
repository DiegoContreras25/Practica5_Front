...
import {
  ...
  getProjectsFromCookieClient,
  saveProjectsToCookie,
} from "../../Cookies.ts";
...
// Modal
const Modal: FunctionComponent<ModalContentProps> = (
  { closeModal, filmID },
) => {
  ...
  const [projects, setProjects] = useState<Cookie[]>(
    getProjectsFromCookieClient(),
  ); // Lista de proyectos
    ...
    <div className="modal" style={{ display: "block" }}>
      <div className="modal-content">
        ...
        {!showCreateProject && !showAddToProject && (
          <div>
            <button class="CreateProjectButton" onClick={openCreateProject}>
              Crear Proyecto
            </button>
            <button class="AddToProjectButton" onClick={openAddToProject}>
              Añadir al Proyecto
            </button>
          </div>
        )}
        ...
        {showAddToProject && (
          <Add_To_Project
            projects={projects}
            onAdd={(projectName) => handleAddToProject(projectName, filmID)}
