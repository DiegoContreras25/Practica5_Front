...
// Componente
const New_Project: FunctionComponent<NewProjectProps> = (
  { onCreate, onClose },
) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      />
      <button class="ConfirmCreateProject" type="submit">Crear Proyecto</button>
      <button class="CloseButton" type="button" onClick={onClose}>
        Cerrar
      </button>
    </form>
  );
