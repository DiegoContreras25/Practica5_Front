...
const Add_To_Project: FunctionComponent<
  {
    projects: Cookie[];
...
> = ({ projects, onAdd, onClose }) => {
  ...
  return (
    <div>
      ...
      <button class="AddToCurrentProjectButton" onClick={handleAddClick}>
        Añadir al proyecto actual
      </button>
      <button class="CloseButton" onClick={onClose}>cerrar</button>
    </div>
  );
};
